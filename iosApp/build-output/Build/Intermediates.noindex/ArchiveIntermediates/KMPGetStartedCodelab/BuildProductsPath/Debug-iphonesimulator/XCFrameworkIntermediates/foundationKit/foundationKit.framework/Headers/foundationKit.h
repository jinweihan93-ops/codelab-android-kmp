...
@class FoundationKitNetworkStateError, FoundationKitNetworkStateLoading, FoundationKitNetworkStateSuccess, FoundationKitRequestPayload, FoundationKitResponseResult, FoundationKitSharedData;
...
+ (FoundationKitRequestPayload *)createTestRequest __attribute__((swift_name("createTestRequest()")));
+ (FoundationKitResponseResult *)createTestResponse __attribute__((swift_name("createTestResponse()")));
+ (NSString *)debugDumpAnyResponseObj:(id)obj __attribute__((swift_name("debugDumpAnyResponse(obj:)")));
+ (NSString *)debugDumpResponseR:(FoundationKitResponseResult *)r __attribute__((swift_name("debugDumpResponse(r:)")));
